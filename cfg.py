...
def parse_args():    
    ...
    parser.add_argument('-dim', type=int, default=256, help='dim_size')
    ...
    parser.add_argument('-one_ckpt', default=None , help='one checkpoint address')
    ...
    help='The path of segmentation data')
     # Add the num_workers argument here
